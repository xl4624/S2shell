...
const MAX_XYZ_TO_UV_ERROR: f64 = 0.5 * f64::EPSILON;
...
pub fn st_to_si_ti(s: f64) -> u32 {
    (s * MAX_SI_TI as f64).round() as u32
}

/// Convert (face, u, v) coordinates to a direction vector (not
/// necessarily unit length).
pub fn face_uv_to_xyz(face: i8, u: f64, v: f64) -> S2Point {
    todo!()
}
